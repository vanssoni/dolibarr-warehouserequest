...
/**
 * \file    test/phpunit/WarehouserequestFunctionalTest.php
...
/**
 * Class WarehouserequestFunctionalTest
 *
 ...
 *
 * @package Testwarehouserequest
 */
class WarehouserequestFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 800200; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modWarehouserequest')->click();
		} else {
			// Disable the module
			$this->byHref('modWarehouserequest')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/warehouserequest/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('warehouserequest/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/warehouserequest/admin/about.php');
		$this->authenticate();
		return $this->assertContains('warehouserequest/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('warehouserequestwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modWarehouserequest_WarehouserequestTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modWarehouserequest_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
